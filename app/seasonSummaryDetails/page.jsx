...
import { seasons, getLocalStorage } from "../../networkApi/Constants";
...
const Page = () => {
  ...
  const seasonId = getLocalStorage("selectedRowId");
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await api.getDataWithToken(`${seasons}/${seasonId}`);
